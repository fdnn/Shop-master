					...
					<div class="main_lr">
						<div class="main_bc">
							<div class="main_bar_shuxing">
								 <span style="float:left">&nbsp;商品&nbsp;>&nbsp;特价</span>
							</div>
							<div class="main_context">
			        			<table width="99%" align="center" >
										  ...
										  <s:iterator value="#request.goodsYesTuijianList" id="goods">
											  <tr align="center">
				        			...
				        			<nav>
									  <ul class="pagination">
									    <li>
									      <a href="<%=path %>/goodsAllYesTuijian.action?page=1" aria-label="Previous">
									        <span aria-hidden="true">&laquo;</span>
									      </a>
									    </li>
									    <s:iterator value="#request.totalPageList" id="list">
									    	<li><a href="<%=path %>/goodsAllYesTuijian.action?page=<s:property value='#list'/>"><s:property value="#list"/></a></li>
									    </s:iterator>
									    <li>
									      <a href="<%=path %>/goodsAllYesTuijian.action?page=<s:property value='#request.totalPage'/>" aria-label="Next">
