							...
							<div class="main_context">
			        			<table width="99%" align="center" >
				        			...
				        			<nav>
									  <ul class="pagination">
									    <li>
									      <a href="<%=path %>/goodsAllYesTejia.action?page=1" aria-label="Previous">
									        <span aria-hidden="true">&laquo;</span>
									      </a>
									    </li>
									    <s:iterator value="#request.totalPageList" id="list">
									    	<li><a href="<%=path %>/goodsAllYesTejia.action?page=<s:property value='#list'/>"><s:property value="#list"/></a></li>
									    </s:iterator>
									    <li>
									       <a href="<%=path %>/goodsAllYesTejia.action?page=<s:property value='#request.totalPage'/>" aria-label="Next">
